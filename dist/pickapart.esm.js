...
var index = (function (paths, source) {
  if (Array.isArray(paths) && !source) {
    source = cloneDeep_1(paths);
    return [].concat(_toConsumableArray(source));
  }
  var parts = at_1(source, paths);
  var remains = Array.isArray(source) ? toArray_1(omit_1(source, paths)) : omit_1(source, paths);
